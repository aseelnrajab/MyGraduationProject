...
//بداية وضع القيم البدائيه لخطوط الطول والعرض
                  Visibility(
                    ...
                    replacement: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          //من خلال هاد البوتون بنروح نجيب احداثيات الموقع
                      ...
                      onPressed: () async {
                        ...
                        List<double> data = await Navigator.push(
                            ...
                            MaterialPageRoute(
                                ...
                                //هون بكل مره بننشئ الطلب بضيفه عالماب
                                // من خلال استدعاء هاد الفنكشن:
                                //هيك بنكون حددنا موقع المكان عن طريق الخريطه
                                AddOrderMap()));
                        //وبعمم قيم الخطوط على الكلاس
                        setState(() {
                          latitude = data[0];
                          longitude = data[1];
                        });
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                        stream:
                            //هون بيقرأ كل الشركات التوصيل بجيبها من الفايربيس و
                        //وبظهرها للمتجر لحتى يقدر يختارها
...
//لبناء نص واجهه بتظهر الرقم التتبعي
              ...
              child: Stack(children: [
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    //لو ضغط المستخدم ماكان برا الواجهه ويعمل بوب لهاي الواجهه
